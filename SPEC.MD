...
Network flags:
FlagDescription-nNumber of results (default: 20)--allPaginate through all results (until exhausted)--ofList a connection's connections (username, URL, or URN)--confirmRequired for bulk operations like --accept-all
