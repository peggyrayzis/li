...
The LinkedIn CLI for agents. Cookie auth, Voyager API. See SPEC.MD for full details.
...
Read-only MVP. Write commands are deferred to v0.2.
...
- `send`, `connect`, `invites --accept` (write commands)
